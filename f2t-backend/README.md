...
- Install dependencies (only do it for the first time)
...
- These files might need to be imported to authenticate information:
    - /plugins/authentication.ts
    - /routes/authentication.ts

- Code to call the cookie and JWT variables from .env using /plugins/authentication.ts:
    - process.env.JWT_SECRET_KEY
    - process.env.COOKIE_SECRET_KEY

- Fastify commands should be global
